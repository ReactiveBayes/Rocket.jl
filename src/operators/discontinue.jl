...
actor_proxy!(::Type{L}, proxy::DiscontinueProxy, actor::A) where {L,A} =
    DiscontinueActor{L,A}(actor)
...
setcompletepropagated!(actor::DiscontinueActor, value::Bool) =
    actor.iscompletepropagated = value
