...
@testset "Subscribable" begin
    ...
    Rocket.as_subscribable(::Type{<:ExplicitlyDefinedSimpleSubscribable}) =
        SimpleSubscribableTrait{String}()

    struct ExplicitlyDefinedScheduledSubscribable end
    Rocket.as_subscribable(::Type{<:ExplicitlyDefinedScheduledSubscribable}) =
    ...
    @testset "as_subscribable" begin
        ...
        @test as_subscribable(NotImplementedScheduledSubscribable) ===
              ScheduledSubscribableTrait{Int}()

        # Check if as_subscribable returns valid subscribable type for explicitly defined types
        @test as_subscribable(ExplicitlyDefinedSimpleSubscribable) ===
              SimpleSubscribableTrait{String}()
        @test as_subscribable(ExplicitlyDefinedScheduledSubscribable) ===
              ScheduledSubscribableTrait{String}()
    end
    ...
    @testset "subscribe!" begin
        ...
        @test_throws MissingOnScheduledSubscribeImplementationError subscribe!(
            NotImplementedScheduledSubscribable(),
            void(Any),
        )
        @test_throws MissingOnSubscribeImplementationError subscribe!(
            ExplicitlyDefinedSimpleSubscribable(),
            void(Any),
        )
        @test_throws MissingOnScheduledSubscribeImplementationError subscribe!(
            ExplicitlyDefinedScheduledSubscribable(),
            void(Any),
        )
        ...
        actor = SimpleActor{String}()
        @test_throws InconsistentActorWithSubscribableDataTypesError subscribe!(
            ImplementedScheduledSubscribable(),
            actor,
        )
        @test actor.events == []
    end
    ...
    @testset "subscribe! with factory" begin
        @test_throws MissingCreateActorFactoryImplementationError subscribe!(
            ImplementedSimpleSubscribable(),
        ...
        @test subscribe!(ImplementedSimpleSubscribable(), ImplementedFactory()) ===
              voidTeardown
        @test actor.events == [1]

        @test subscribe!(ImplementedScheduledSubscribable(), ImplementedFactory()) ===
              voidTeardown
    ...
    @testset "Subscribable extract type and eltype" begin
        ...
        @test Rocket.subscribable_extract_type(ExplicitlyDefinedSimpleSubscribable) ===
              String
        @test Rocket.subscribable_extract_type(ExplicitlyDefinedScheduledSubscribable) ===
              String
        ...
        @test Rocket.subscribable_extract_type(NotImplementedSubscribable()) === Int
        @test Rocket.subscribable_extract_type(NotImplementedScheduledSubscribable()) ===
              Int
        @test Rocket.subscribable_extract_type(ExplicitlyDefinedSimpleSubscribable()) ===
              String
        @test Rocket.subscribable_extract_type(ExplicitlyDefinedScheduledSubscribable()) ===
        ...
        @test_throws InvalidSubscribableTraitUsageError Rocket.subscribable_extract_type(
            DummyType,
        )
        @test_throws InvalidSubscribableTraitUsageError Rocket.subscribable_extract_type(
            DummyType(),
